...
public class JdParse {
    public static List<JdBook> getData (String html) throws Exception{
        //获取的数据，存放在集合中
        List<JdBook> data = new ArrayList<JdBook>();
        //采用Jsoup解析
        Document doc =  Jsoup.connect("http://search.jd.com/Search?keyword=Python&enc=utf-8&book=y&wq=Python&pvid=33xo9lni.p4a1qb").get();
        //获取html标签中的内容
